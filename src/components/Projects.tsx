...
const projects: Project[] = [
  {
    id: 1,
    title: 'Thesis: Multimodal Fusion Strategies for Survival Prediction in ccRCC',
    description: 'Barrett Honors Thesis fusing medical imaging and genomic data to predict survival outcomes for Clear Cell Renal Cell Carcinoma, in collaboration with Mayo Clinic.',
    ...
    demo: 'https://www.linkedin.com/in/arnav-arora-a35027256/overlay/Project/1439617808/treasury?profileId=ACoAAD8B9wkBWjSBsD2xGLV9WsttsfTWAS_8jK0'
  },
  {
    id: 2,
    title: 'CareAscension',
    description: 'Founding Engineer — built a real-time shelter navigation platform, selected for the 2026 City of Phoenix pilot with the Office of Homeless Solutions.',
    tags: ['React', 'Python', 'WebSockets', 'Startup', 'Civic Tech'],
    image: 'https://images.pexels.com/photos/442151/pexels-photo-442151.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    demo: 'https://www.careascension.com'
  },
  {
    id: 3,
...
export default Projects;    tags: ['C', 'Sockets', 'Hash Maps', 'P2P', 'Distributed Software'],
    image: 'https://images.pexels.com/photos/1148820/pexels-photo-1148820.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    github: 'https://github.com/aarora80/SocketProject.git'
  },
  {
