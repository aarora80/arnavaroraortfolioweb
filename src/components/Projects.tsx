...
const projects: Project[] = [
  {
    ...
    description: 'Leading thesis research under Dr. YooJung Choi to develop a multimodal probabilistic AI model to predict disease progression @ MayoClinic Hospital.',
