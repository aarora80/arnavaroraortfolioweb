...
const projects: Project[] = [
  {
    ...
    description: 'Leading thesis research under Dr. YooJung Choi to develop a multimodal probabilistic AI model to predict disease progression using PyTorch and Probabilistic Circuits.',
  ...
  },
  {
    ...
    description: 'Built an API to predict Remaining Useful Life (RUL) using CMAPSS datasets, improving maintenance scheduling efficiency with Python and Flask.',
  ...
  },
  {
    ...
    description: 'Built a high-performance P2P protocol in C with Hot Potato routing, custom DHT, and socket-based message passing across nodes.',
